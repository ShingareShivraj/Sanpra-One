...
import '../add_attendance_request/add_attendance_request_screen.dart';
import 'list_attendance_request_viewmodel.dart';
...
class AttendanceRequestScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<AttendanceRequestListViewModel>.reactive(
      viewModelBuilder: () => AttendanceRequestListViewModel(),
      onViewModelReady: (model) => model.initialise(),
      builder: (context, model, child) => Scaffold(
        /// ================= APP BAR =================
        appBar: AppBar(
          title: const Text("My Attendance Requests"),
          elevation: 0,
        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            final result = await Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => const AddAttendanceRequestScreen(),
              ),
            );
  ...
  Widget _filterBar(
    ...
    AttendanceRequestListViewModel model,
  ) {
    return Container(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          /// EXPLANATION
          if (r.explanation?.isNotEmpty == true)
            Text(
