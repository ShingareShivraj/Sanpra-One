...
class ItemDistributorScreen extends StatelessWidget {
  final String warehouse;
  final List<Items> selectedItems;
  final List<Items> items;

  const ItemDistributorScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ItemDistributorListModel>.reactive(
      viewModelBuilder: () => ItemDistributorListModel(),
...
class BottomSheetWidget extends StatelessWidget {
  final ItemDistributorListModel model;
